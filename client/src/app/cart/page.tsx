    ...
    <div className="flex flex-col gap-8 items-center justify-center mt-12 ">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
       ...
       <div className="w-full flex flex-col lg:flex-row gap-16">
        ...
        {activeStep === 1 && <button onClick={() => router.push("/cart?step=2",{scroll:false})} className="w-full bg-gray-800 text-white p-2 rounded-lg cursor-pointer flex items-center justify-center gap-2 hover:bg-gray-900 transition-all duration-300">
          Continue
